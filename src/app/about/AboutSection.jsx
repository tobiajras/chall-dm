...
const AboutSection = () => {
  return (
    <section
      id='aboutSection'
      className=' w-full bg-color-title relative h-40 sm:h-72'
    >
      <div className='absolute mx-4 sm:mx-8 md:mx-10 top-0 left-0 right-0 flex justify-center gap-8 mt-12 sm:mt-32 lg:mt-20 text-[#D2DFFF]'>
        <div className='max-w-6xl flex justify-center gap-3 sm:gap-8'>
          <article className='flex bg-color-primary px-3 sm:px-7 pt-4 pb-4 sm:pb-6 md:pb-8 lg:pb-10 w-full rounded sm:rounded-md'>
            <div className='w-full'>
              ...
              <button className='text-nowrap text-[10px] sm:text-xs md:text-sm lg:text-base py-2 px-3 sm:px-7 border border-color-[#D2DFFF] rounded mt-3 sm:mt-4 md:mt-5 lg:mt-8 hover:text-color-primary hover:bg-color-title transition-colors'>
                Hire us
              </button>
            </div>
