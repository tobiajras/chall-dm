...
const TechnologySection = () => {
  return (
    ...
    >
      <div className='max-w-6xl flex flex-col gap-6 sm:gap-0 sm:flex-row items-center w-full mx-6 sm:mx-8 md:mx-10'>
        ...
        <article className='grid grid-cols-6 sm:grid-cols-2 gap-x-3 gap-y-3 pl-3 sm:gap-x-10 md:gap-x-10 lg:gap-x-24 sm:gap-y-10 sm:p-10 md:p-12'>
